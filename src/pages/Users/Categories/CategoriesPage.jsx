            ...
            {products?.map((item) => {
                ...
                >
                    ...
                    >
                        ...
                        {/* Product Info */}
                        <div className="flex flex-col gap-1 text-sm" style={{ padding: "10px" }}>
                            ...
                            <Button type="primary" className="bg-purple-600 text-white text-sm rounded-lg py-2 mt-2 hover:bg-purple-700 transition">
                                Savatga
                            </Button>
                        </div>
                    </div>
