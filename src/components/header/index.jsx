        ...
        <div className="nav">
            ...
            >
                <Form.Item name="username"
                    style={{ margin: "0", borderTopEndRadius: "0", borderBottomEndRadius: "0", width: "100%", }}>
                    <Input.Search placeholder='Mahsulotni izlash...'
                        style={{
                            width: "100%",
        ...
        >
            {data?.map((item, index) => {
                return <div
                    key={index}
                    className="category"
                    style={{ padding: "5px", border: "1px solid", margin: "5px 0", cursor: "pointer", fontWeight: "500", }}
                    onClick={() => {
